...
import (
	...
	eventsv1 "github.com/gitfrok/backend/gen/events/repository/v1"
	"github.com/gitfrok/backend/modules/repository/api"
	"google.golang.org/protobuf/proto"
	"google.golang.org/protobuf/reflect/protoreflect"
)

// This is the T-0008 AC3 contract test. The in-process events a module publishes on the bus are
// plain Go structs — a module's api/ surface stays free of infrastructure (invariant 20), so it
// cannot expose generated protobuf types directly. That freedom is only safe if the two shapes are
// held in lockstep, which is what makes extraction to Redpanda (ADR-0026) mechanical: the
// publisher swaps bus.Publish for a producer and the payload maps field-for-field.
//
...
var eventPairs = []struct {
	...
	{"RepositoryCreated", api.RepositoryCreated{}, (*eventsv1.RepositoryCreated)(nil)},
	{"RefUpdated", api.RefUpdated{}, (*eventsv1.RefUpdated)(nil)},
}
